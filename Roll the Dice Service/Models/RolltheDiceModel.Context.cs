...
namespace Roll_the_Dice_Service.Models
{
    ...
    public partial class RolltheDiceEntities : DbContext
    {
        public RolltheDiceEntities()
            : base("name=RolltheDiceEntities")
        {
        }
        ...
        public virtual DbSet<Union_Habil_Pers> Union_Habil_Pers { get; set; }
        public virtual DbSet<Union_Invent_Item> Union_Invent_Item { get; set; }
        public virtual DbSet<Union_Stat_Pers> Union_Stat_Pers { get; set; }
    }
}
