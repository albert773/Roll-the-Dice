...
namespace RolltheDiceService.Models
{
    ...
    public partial class RolltheDiceDBEntities : DbContext
    {
        ...
        public virtual DbSet<UnionEstatMonst> UnionEstatMonst { get; set; }
        public virtual DbSet<UnionEstatNPC> UnionEstatNPC { get; set; }
        public virtual DbSet<UnionEstatPerso> UnionEstatPerso { get; set; }
